...
class MainHandler(webapp2.RequestHandler):
	def get(self):
		...
		self.response.headers['Content-disposition'] = 'attachment; filename="noiseSources.xls"'
