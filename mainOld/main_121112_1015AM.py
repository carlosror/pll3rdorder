...
enteredP, enteredT31, enteredGamma):
	book = Workbook()
	...
	sheetLoopFilter.write(0,0,'C1',columnHeaderBorderTL)
	sheetLoopFilter.write(0,1,C1,parameterValueBorderTR)
	sheetLoopFilter.write(1,0,'C2',columnHeaderBorderL)
	sheetLoopFilter.write(1,1,C2,parameterValueBorderR)
	sheetLoopFilter.write(2,0,'C3',columnHeaderBorderL)
	sheetLoopFilter.write(2,1,C3,parameterValueBorderR)
	sheetLoopFilter.write(3,0,'R2',columnHeaderBorderL)
	sheetLoopFilter.write(3,1,R2,parameterValueBorderR)
	sheetLoopFilter.write(4,0,'R3',columnHeaderBorderBL)
	sheetLoopFilter.write(4,1,R3,parameterValueBorderBR)
	...
	sheetphaseError.write(8,4,"Calculations made using interpolated data",notes)
...
class MainHandler(webapp2.RequestHandler):
	...
	def post(self):
		...
		if (self.request.get("excelResults") == "wantExcelResults"):
			...
			enteredFref, enteredR, enteredP, enteredT31, enteredGamma)
