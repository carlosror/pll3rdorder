...
lockTime_0p000001Pcnt, f2, fInterpol, TotalNoiseV2HzInterpol, Fout):
	book = Workbook()
	...
	sheetphaseError.write(0,2,'Frequency Error Integrand (V2*Hz)',columnHeader)
	...
	sheetphaseError.write(1,4,"Lower Integration Limit (Hz)", columnHeader)
	sheetphaseError.write(2,4,"Upper Integration Limit (Hz)", columnHeader)
	sheetphaseError.write(3,4,"Fout (Hz)", columnHeader)
	sheetphaseError.write(4,4,"RMS Phase Error (degrees)", redResult)
	sheetphaseError.write(5,4,"Jitter (ps)", redResult)
	sheetphaseError.write(6,4,"RMS Frequency Error (Hz)", redResult)
	sheetphaseError.col(5).width = 6000
	sheetphaseError.write(1,5,1.7e3,parameterValue)
	sheetphaseError.write(2,5,200e3,parameterValue)
	sheetphaseError.write(3,5,Fout,parameterValue)
	...
	sheetphaseError.write(4,5,Formula(phaseError),parameterValue2Red)
	sheetphaseError.write(5,5,Formula(jitter),parameterValueRed)
	sheetphaseError.write(6,5,Formula(freqError),parameterValue2Red)
	return book
