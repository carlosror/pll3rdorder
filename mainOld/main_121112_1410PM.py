...
enteredP, enteredT31, enteredGamma, noiseWorkbook):
	book = Workbook()
...
class MainHandler(webapp2.RequestHandler):
	...
	def post(self):
		...
		try:
			...
			workbook = ""
			noiseError = "***WARNING: Empty noise sources spreadsheet or an error occurred while reading the spreadsheet. Using default noise data instead.***" 
